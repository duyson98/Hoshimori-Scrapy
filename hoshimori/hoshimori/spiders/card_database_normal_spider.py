...
class NormalCardDatabaseSpider(scrapy.Spider):
    name = "database_normal"
    allowed_domains = ["wiki.dengekionline.com"]
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': 'results/normal_database.csv',
    ...
    def parse(self, response):
        ...
        nakayoshi = response.xpath('//*[@id="rendered-body"]/div[3]/div')
        ...
        yield {
            ...
            'nakayoshi_target_noevol': nakayoshi.xpath(
                'div[2]/div[1]/div[1]/table/tbody/tr[1]/td[2]/text()').extract_first(),
            'nakayoshi_effect_noevol': nakayoshi.xpath(
                'div[2]/div[1]/div[1]/table/tbody/tr[2]/td[2]/text()').extract_first(),
            'nakayoshi_target_evol': nakayoshi.xpath(
                'div[2]/div[1]/div[2]/div[1]/div/table/tbody/tr[1]/td[2]/text()').extract_first(),
            'nakayoshi_effect_evol': nakayoshi.xpath(
                'div[2]/div[1]/div[2]/div[1]/div/table/tbody/tr[2]/td[2]/text()').extract_first(),
