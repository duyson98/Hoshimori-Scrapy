...
class NormalCardDatabaseSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        yield {
            ...
            'nakayoshi_target_evol':    nakayoshi.xpath('div[2]/div[1]/div[2]/div[1]/div/table/tbody/tr[1]/td[2]/text()').extract_first(),
            'nakayoshi_effect_evol':    nakayoshi.xpath('div[2]/div[1]/div[2]/div[1]/div/table/tbody/tr[2]/td[2]/text()').extract_first(),
